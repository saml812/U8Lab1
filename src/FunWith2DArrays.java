public class FunWith2DArrays
{
  ...
  {
    System.out.println("top left: " + strArray[0][0]);
    System.out.println("top right: " + strArray[0][strArray[0].length-1]);
    System.out.println("bottom left: " + strArray[strArray.length-1][0]);
    System.out.println("bottom left: " + strArray[strArray.length-1][strArray[0].length-1]);
  }
}
